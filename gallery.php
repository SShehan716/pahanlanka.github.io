  ...
  <body>
    <div id="preloader" style="background:rgb(252, 252, 252) url(images/conactus\ background.png); background-repeat:no-repeat; background-size: cover; background-attachment: fixed;">
        ...
        <header>
            ...
            <div style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8)),url(images/gallery\ cover.jpg);overflow: visible; background-position: 50% 100%; background-repeat: no-repeat; background-attachment: fixed; background-size: cover;"
            class="contact-bg">                
