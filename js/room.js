...
function slideImage1() {
  const displayWidth = document.querySelector(
    ".img-showcase1 img:first-child"
  ).clientWidth;

  document.querySelector(".img-showcase1").style.transform = `translateX(${
    -(imgId1 - 1) * displayWidth
  }px)`;
}
...
function slideImage2() {
  ...
  document.querySelector(".img-showcase2").style.transform = `translateX(${
    -(imgId2 - 1) * displayWidth
  }px)`;
}
...
function slideImage3() {
  const displayWidth = document.querySelector(
    ".img-showcase3 img:first-child"
  ).clientWidth;

  document.querySelector(".img-showcase3").style.transform = `translateX(${
    -(imgId3 - 1) * displayWidth
  }px)`;
}
...
function slideImage4() {
  const displayWidth = document.querySelector(
    ".img-showcase4 img:first-child"
  ).clientWidth;

  document.querySelector(".img-showcase4").style.transform = `translateX(${
    -(imgId4 - 1) * displayWidth
  }px)`;
}
