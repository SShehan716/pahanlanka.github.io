...
<body>
    ...
    <header>
        ...
        <div style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8)),url(images/banquet/10.jpg);overflow: visible; background-position: 50% 100%; background-repeat: no-repeat; background-attachment: fixed;"
            class="contact-bg">
            <h3>Find me wherever the pool floats are.</h3>
            <h2>Pool</h2>
            <div class="line">
                <div></div>
                <div></div>
    ...
    <section class="vistUS">
        ...
        <div class="contact-info">
            <div>
                <span><i class="fas fa-solid fa-maximize"></i></span>
                <span>30 x 20</span>
            </div>
            <div>
                <span><i class="fas fa-solid fa-person-booth"></i></span>
                <span>Changing Room</span>
            </div>
            <div>
                <span><i class="fas fa-water-ladder"></i></span>
                <span>Deep 5 1/2</span>
            </div>
            <div>
                <span><i class="fas fa-solid fa-baby"></i></span>
                <span>Baby Pool</span>
            </div>
        </div>
    </section>
